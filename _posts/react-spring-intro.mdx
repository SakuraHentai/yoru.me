...
date: 2021-12-13
demos: ['thumb', 'external-link', 'react-spring-1', 'react-spring-2']
...
<Thumb
  src="https://wx1.sinaimg.cn/mw2000/6708d6c2gy1gxd5rrus5lj20r80dywic.jpg"
  alt="react-spring"
  width={980}
  height={502}
/>
...
如上代码, <ExternalLink href="https://react-spring.io">react-spring</ExternalLink>可简单地使用`useSpring`和`animated(.tag)/a(.tag)`组件实现动画.
...
具体 api 在<ExternalLink href="https://react-spring.io/basics">官网</ExternalLink>上太详细了.
