...
date: 2022-05-20
tags: ['go', 'tcp']
summary: '一天, 收到某局接口计划升级国密通信(sm)的需求, 因现有后端使用php5.4, 便从php开始入手, 结果坑便开始了...'
---
...
<Thumb
  src="https://tva1.sinaimg.cn/large/6708d6c2gy1h2enjq6pb0j20su0bk780.jpg"
  alt="openssl ciphers"
  width={1038}
  height={416}
/>
...
<Thumb
  src="https://tva1.sinaimg.cn/large/6708d6c2gy1h2ep0r9j0oj20a007vdhy.jpg"
  alt="anya wakuwaku"
  note="wakuwaku"
  width={360}
  height={283}
...
<Thumb
  src="https://tva1.sinaimg.cn/large/6708d6c2gy1h2eq1mon2vj21eu1bgwul.jpg"
  alt="babassl init ssl"
  width={1830}
  height={1708}
/>
...
<Thumb
  src="https://tva1.sinaimg.cn/large/6708d6c2gy1h2ertkq1tsj20q503h78c.jpg"
  alt="ssl handshake fail"
  note="bad key share"
  width={941}
  height={125}
/>
...
最后还是万能的中间件, 又因为文档问题浪费大半天. 看源码, 翻遍了文档, 最后在提交更改的 commit 的测试用例找到了 <ExternalLink href="https://github.com/BabaSSL/BabaSSL/commit/61fab104aa51bf47724a169993ff080570dc1316#diff-d2dc4f62796c02c933b84b970395459cfb3d9789a28ba56d49b485b1358df530R387" children={'一丝线索'} />
...
- BabaSSl: <ExternalLink href="https://github.com/BabaSSL/BabaSSL" children={'阿里开源国密实现'} />
- RFC: <ExternalLink href="https://datatracker.ietf.org/doc/html/rfc8998" children={'rfc8998'} />
